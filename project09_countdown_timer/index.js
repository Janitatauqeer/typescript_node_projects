...
console.log("\t", "\t", "<".repeat(15), chalk.bold.magenta("Welcome_To_JanitaTauqeer_Countdown_Timer"), ">".repeat(15));
console.log("\t", "=".repeat(85));
...
function startTime(totalSeconds) {
    ...
    const timer = setInterval(() => {
        ...
        console.log(chalk.cyan(`${hours.toString().padStart(2, "0")}:${minutes
            .toString()
