    ...
    let taskIndex = await inquirer.prompt([
        {
            name: "index",
            type: "number",
            message: chalk.cyanBright("Enter the `index no.`of the task you want to delete:"),
        },
    ]);
...
let upgradeTask = async () => {
    ...
    console.log(chalk.bgBlue(`\n\t Task at index no."${upgrade_task_index.index - 1}" Updated successfully [For updated list , Please check option "View Todo-List"] \n`));
};
